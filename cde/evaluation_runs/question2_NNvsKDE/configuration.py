...
def issue2():
  ...
  "ConditionalKernelDensityEstimation": tuple(itertools.product(
        ['normal_reference', 'cv_ml', 'cv_ls'] #bandwidth_selection
          ))
  }
...
if __name__ == '__main__':
    ...
    path_pickle = "question1_noise_reg_result_03-27-18_17-15-29.csv"
